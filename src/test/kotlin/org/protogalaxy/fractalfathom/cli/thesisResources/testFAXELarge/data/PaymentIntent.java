...
package org.protogalaxy.fractalfathom.cli.thesisResources.testFAXELarge.data;
...
public final class PaymentIntent implements Parcelable {
    ...
    public static PaymentIntent fromBitcoinUri(final BitcoinURI bitcoinUri) {
		...
		//&begin[Codecs]
        return new PaymentIntent(Standard.BIP21, null, null, outputs, bitcoinUri.getLabel(),	//&line[BIP21]
		//&end[Codecs]
