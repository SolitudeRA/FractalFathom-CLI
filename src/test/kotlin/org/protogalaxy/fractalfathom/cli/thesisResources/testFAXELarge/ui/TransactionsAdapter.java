...
package org.protogalaxy.fractalfathom.cli.thesisResources.testFAXELarge.ui;
    ...
    public TransactionsAdapter(final Context context, final int maxConnectedPeers,
        ...
        super(new DiffUtil.ItemCallback<ListItem>() {
            ...
            public boolean areItemsTheSame(final ListItem oldItem, final ListItem newItem) {
                if (oldItem instanceof ListItem.TransactionItem) {
                    if (!(newItem instanceof ListItem.TransactionItem))
                        return false;
                    return Objects.equals(((ListItem.TransactionItem) oldItem).transactionHash,
                            ((ListItem.TransactionItem) newItem).transactionHash);
                } else {
                    if (!(newItem instanceof ListItem.WarningItem))
                        return false;
                    return Objects.equals(((ListItem.WarningItem) oldItem).type, ((ListItem.WarningItem) newItem).type);
                }
            }
            ...
            public boolean areContentsTheSame(final ListItem oldItem, final ListItem newItem) {
                if (oldItem instanceof ListItem.TransactionItem) {
                    final ListItem.TransactionItem oldTransactionItem = (ListItem.TransactionItem) oldItem;
                    final ListItem.TransactionItem newTransactionItem = (ListItem.TransactionItem) newItem;
